package nl.itris.mjop.handelingen.boundary;
...
public class Deelhandeling   {
  ...
  public Deelhandeling(nl.itris.mjop.handelingen.entity.Deelhandeling aDeelhandeling) {
    this();
  ...
  private void initializeFrom(nl.itris.mjop.handelingen.entity.Deelhandeling aDeelhandeling) {
